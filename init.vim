...
set background=dark
set t_Co=256
silent! colorscheme dracula " theme (silent because plugins might not be installed)
" let g:airline_theme=''
...
set list listchars=tab:\ \ ,trail:_ " show whitespace at eol
...
let g:airline#extensions#tmuxline#enabled = 0 " theme is set manually
...
function! GetDate(format)
  let format = empty(a:format) ? '+%F' : a:format
